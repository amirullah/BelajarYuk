...
class ContentKelas3 {
  ...
  static final List<Question> _english = [
    ...
    const Question(question: 'Which animal says "Meow"?', emoji: '🐱', options: ['Dog', 'Cat', 'Cow', 'Duck'], correctIndex: 1),
    const Question(question: 'What color is the sky on a clear day?', emoji: '☀️', options: ['Green', 'Blue', 'Brown', 'Black'], correctIndex: 1),
    const Question(question: 'Which word is a fruit?', emoji: '🍎', options: ['Apple', 'Chair', 'Table', 'Shoe'], correctIndex: 0),
    const Question(question: 'How many days are there in one week?', emoji: '📅', options: ['Five', 'Six', 'Seven', 'Ten'], correctIndex: 2),
    const Question(question: 'Choose the correct sentence.', emoji: '✏️', options: ['She are happy.', 'She is happy.', 'She am happy.', 'She be happy.'], correctIndex: 1),
    const Question(question: 'What is the opposite of "big"?', emoji: '📏', options: ['Tall', 'Small', 'Wide', 'Long'], correctIndex: 1),
    const Question(question: 'What do we use to write on paper?', emoji: '🖊️', options: ['Pencil', 'Spoon', 'Cup', 'Ball'], correctIndex: 0),
    const Question(question: 'Which is a part of the body?', emoji: '🖐️', options: ['Window', 'Hand', 'Door', 'Roof'], correctIndex: 1),
    const Question(question: 'Fill the blank: "I ___ a student."', emoji: '🎒', options: ['is', 'am', 'are', 'be'], correctIndex: 1),
    const Question(question: 'What is the plural of "cat"?', emoji: '🐈', options: ['Cat', 'Cats', 'Cates', 'Caties'], correctIndex: 1),
    const Question(question: 'Which word means the number 3?', emoji: '3️⃣', options: ['Two', 'Three', 'Four', 'Five'], correctIndex: 1),
    Question.trueFalse(statement: 'A banana is yellow.', isTrue: true, emoji: '🍌'),
    Question.trueFalse(statement: 'The word "run" is a color.', isTrue: false, emoji: '🏃'),
    Question.trueFalse(statement: 'We use our eyes to see.', isTrue: true, emoji: '👀'),
    Question.trueFalse(statement: '"Monday" comes after "Sunday".', isTrue: true, emoji: '📆'),
    Question.trueFalse(statement: 'A fish can walk on land.', isTrue: false, emoji: '🐟'),
    const Question(question: 'Write the English word for the animal that says "Woof".', emoji: '🐶', type: QuestionType.fillBlank, answer: 'dog'),
    const Question(question: 'What color do you get: "The grass is ___"?', emoji: '🌱', type: QuestionType.fillBlank, answer: 'green'),
    const Question(question: 'Fill the blank: "Good ___! It is time to sleep." (said at night)', emoji: '🌙', type: QuestionType.fillBlank, answer: 'night'),
  ...
  static final List<Question> _indonesian = [
    ...
    const Question(question: 'Lawan kata dari \'rajin\' adalah ...', emoji: '📚', options: ['pintar', 'malas', 'cepat', 'kuat'], correctIndex: 1),
    const Question(question: 'Lawan kata dari \'tinggi\' adalah ...', emoji: '📏', options: ['besar', 'pendek', 'panjang', 'lebar'], correctIndex: 1),
    const Question(question: 'Huruf pertama pada nama orang harus ditulis dengan huruf ...', emoji: '✍️', options: ['kecil', 'kapital', 'miring', 'tebal'], correctIndex: 1),
    ...
    const Question(question: 'Kata dasar dari \'bermain\' adalah ...', emoji: '⚽', options: ['main', 'ber', 'bermai', 'permainan'], correctIndex: 0),
    const Question(question: 'Lawan kata dari \'gelap\' adalah ...', emoji: '💡', options: ['terang', 'hitam', 'malam', 'sepi'], correctIndex: 0),
    const Question(question: 'Kata \'kupu-kupu\' termasuk kata ...', emoji: '🦋', options: ['dasar', 'ulang', 'depan', 'tanya'], correctIndex: 1),
    const Question(question: 'Sinonim (persamaan kata) dari \'pandai\' adalah ...', emoji: '🧠', options: ['bodoh', 'pintar', 'nakal', 'lambat'], correctIndex: 1),
    const Question(question: 'Nama hari selalu ditulis dengan huruf awal ...', emoji: '📅', options: ['kecil', 'kapital', 'angka', 'miring'], correctIndex: 1),
    Question.trueFalse(statement: 'Nama kota seperti \'Jakarta\' ditulis dengan huruf kapital di awal.', isTrue: true, emoji: '🏙️'),
    Question.trueFalse(statement: 'Lawan kata dari \'panas\' adalah \'hangat\'.', isTrue: false, emoji: '🌡️'),
    Question.trueFalse(statement: 'Kalimat perintah biasanya diakhiri dengan tanda seru (!).', isTrue: true, emoji: '❗'),
    ...
    const Question(question: 'Kata \'meja\' terdiri dari ... suku kata. (isi dengan angka)', emoji: '🪑', type: QuestionType.fillBlank, answer: '2'),
  ...
  static final List<Question> _science = [
    ...
    const Question(question: 'Bagian tumbuhan yang berfungsi menyerap air dari dalam tanah adalah...', emoji: '🌱', options: ['Daun', 'Akar', 'Bunga', 'Buah'], correctIndex: 1),
    const Question(question: 'Hewan yang hidup di dua alam, yaitu di air dan di darat disebut...', emoji: '🐸', options: ['Mamalia', 'Reptil', 'Amfibi', 'Serangga'], correctIndex: 2),
    const Question(question: 'Proses tumbuhan membuat makanannya sendiri dengan bantuan sinar matahari disebut...', emoji: '☀️', options: ['Penguapan', 'Fotosintesis', 'Pernapasan', 'Pencernaan'], correctIndex: 1),
    const Question(question: 'Alat pernapasan pada ikan adalah...', emoji: '🐟', options: ['Paru-paru', 'Insang', 'Kulit', 'Trakea'], correctIndex: 1),
    const Question(question: 'Berikut ini yang termasuk benda cair adalah...', emoji: '💧', options: ['Batu', 'Air', 'Kayu', 'Besi'], correctIndex: 1),
    const Question(question: 'Planet tempat kita tinggal bernama...', emoji: '🌍', options: ['Mars', 'Bumi', 'Venus', 'Jupiter'], correctIndex: 1),
    const Question(question: 'Hewan di bawah ini yang berkembang biak dengan cara bertelur adalah...', emoji: '🐔', options: ['Sapi', 'Kucing', 'Ayam', 'Kambing'], correctIndex: 2),
    const Question(question: 'Sumber energi terbesar bagi kehidupan di Bumi adalah...', emoji: '🌞', options: ['Bulan', 'Matahari', 'Bintang', 'Api'], correctIndex: 1),
    const Question(question: 'Tempat hidup asli seekor unta adalah di...', emoji: '🐪', options: ['Kutub', 'Gurun pasir', 'Laut dalam', 'Hutan hujan'], correctIndex: 1),
    const Question(question: 'Ketika air dipanaskan terus-menerus hingga mendidih, air akan berubah menjadi...', emoji: '♨️', options: ['Es', 'Uap', 'Batu', 'Tanah'], correctIndex: 1),
    const Question(question: 'Bagian tubuh yang kita gunakan untuk mencium bau adalah...', emoji: '👃', options: ['Mata', 'Telinga', 'Hidung', 'Lidah'], correctIndex: 2),
    const Question(question: 'Cuaca ketika langit tertutup awan tebal dan turun air disebut cuaca...', emoji: '🌧️', options: ['Cerah', 'Hujan', 'Berangin', 'Panas'], correctIndex: 1),
    Question.trueFalse(statement: 'Kupu-kupu berasal dari ulat yang mengalami perubahan bentuk.', isTrue: true, emoji: '🦋'),
    Question.trueFalse(statement: 'Matahari terbit dari arah barat pada pagi hari.', isTrue: false, emoji: '🧭'),
    Question.trueFalse(statement: 'Manusia bernapas menghirup oksigen dan mengeluarkan karbon dioksida.', isTrue: true, emoji: '🫁'),
    Question.trueFalse(statement: 'Batu termasuk makhluk hidup karena bisa membesar.', isTrue: false, emoji: '🪨'),
    Question.trueFalse(statement: 'Tumbuhan hijau membutuhkan cahaya matahari untuk tumbuh dengan baik.', isTrue: true, emoji: '🌿'),
    const Question(question: 'Jumlah kaki pada seekor laba-laba ada ... buah.', emoji: '🕷️', type: QuestionType.fillBlank, answer: '8'),
    const Question(question: 'Benda langit yang bersinar di malam hari dan mengelilingi Bumi disebut ...', emoji: '🌙', type: QuestionType.fillBlank, answer: 'Bulan'),
    const Question(question: 'Warna daun yang sehat pada umumnya adalah ...', emoji: '🍃', type: QuestionType.fillBlank, answer: 'Hijau'),
  ...
  static final List<Question> _religion = [
    ...
    const Question(question: 'Rukun Islam ada berapa?', emoji: '🕌', options: ['3', '4', '5', '6'], correctIndex: 2),
    const Question(question: 'Rukun Islam yang pertama adalah?', emoji: '🤲', options: ['Membaca dua kalimat syahadat', 'Puasa', 'Zakat', 'Haji'], correctIndex: 0),
    const Question(question: 'Kita mengerjakan salat wajib sebanyak berapa kali dalam sehari semalam?', emoji: '🕋', options: ['3 kali', '5 kali', '7 kali', '10 kali'], correctIndex: 1),
    const Question(question: 'Sebelum salat, kita harus bersuci dengan cara?', emoji: '💧', options: ['Tidur', 'Wudhu', 'Makan', 'Bermain'], correctIndex: 1),
    const Question(question: 'Salat yang dikerjakan pada pagi hari sebelum matahari terbit adalah?', emoji: '🌅', options: ['Zuhur', 'Asar', 'Subuh', 'Isya'], correctIndex: 2),
    const Question(question: 'Doa yang kita baca sebelum makan diawali dengan bacaan?', emoji: '🍽️', options: ['Alhamdulillah', 'Bismillah', 'Astagfirullah', 'Subhanallah'], correctIndex: 1),
    const Question(question: 'Kitab suci umat Islam adalah?', emoji: '📖', options: ['Al-Qur\'an', 'Injil', 'Taurat', 'Zabur'], correctIndex: 0),
    const Question(question: 'Nabi terakhir yang diutus Allah adalah?', emoji: '🌟', options: ['Nabi Adam', 'Nabi Muhammad SAW', 'Nabi Isa', 'Nabi Musa'], correctIndex: 1),
    const Question(question: 'Saat wudhu, setelah membasuh muka kita membasuh?', emoji: '🖐️', options: ['Kaki', 'Kedua tangan sampai siku', 'Rambut', 'Telinga'], correctIndex: 1),
    const Question(question: 'Kepada siapa kita harus berbakti dan berbuat baik di rumah?', emoji: '👨‍👩‍👧', options: ['Orang tua', 'Teman jauh', 'Tetangga saja', 'Guru saja'], correctIndex: 0),
    const Question(question: 'Kalimat yang kita ucapkan saat bertemu sesama muslim adalah?', emoji: '🤝', options: ['Terima kasih', 'Assalamualaikum', 'Selamat tinggal', 'Permisi'], correctIndex: 1),
    const Question(question: 'Nabi yang membangun kapal besar atas perintah Allah adalah?', emoji: '⛵', options: ['Nabi Yusuf', 'Nabi Nuh', 'Nabi Yunus', 'Nabi Daud'], correctIndex: 1),
    Question.trueFalse(statement: 'Rukun Iman yang pertama adalah iman kepada Allah.', isTrue: true, emoji: '❤️'),
    Question.trueFalse(statement: 'Kita boleh berbohong kepada orang tua.', isTrue: false, emoji: '🙅'),
    Question.trueFalse(statement: 'Puasa Ramadan dikerjakan pada malam hari saja.', isTrue: false, emoji: '🌙'),
    Question.trueFalse(statement: 'Membaca Al-Qur\'an adalah perbuatan yang baik dan mendapat pahala.', isTrue: true, emoji: '📚'),
    Question.trueFalse(statement: 'Zakat termasuk salah satu Rukun Islam.', isTrue: true, emoji: '💰'),
    const Question(question: 'Jumlah rakaat salat Subuh adalah ... rakaat.', emoji: '🌄', type: QuestionType.fillBlank, answer: '2'),
    const Question(question: 'Umat Islam beribadah salat menghadap ke arah Kakbah yang berada di kota ...', emoji: '🕋', type: QuestionType.fillBlank, answer: 'Mekah'),
    const Question(question: 'Ucapan syukur kepada Allah setelah menerima nikmat adalah ...', emoji: '🤲', type: QuestionType.fillBlank, answer: 'Alhamdulillah'),
  ...
  static final List<Question> _ips = [
    ...
    const Question(question: 'Orang yang bertugas mengajar murid di sekolah disebut...', emoji: '👩‍🏫', options: ['Dokter', 'Guru', 'Petani', 'Sopir'], correctIndex: 1),
    const Question(question: 'Ibu dari ayah kita kita panggil dengan sebutan...', emoji: '👵', options: ['Bibi', 'Nenek', 'Kakak', 'Tante'], correctIndex: 1),
    ...
    const Question(question: 'Warna bendera Indonesia adalah...', emoji: '🇮🇩', options: ['Merah dan putih', 'Biru dan putih', 'Merah dan kuning', 'Hijau dan putih'], correctIndex: 0),
    const Question(question: 'Profesi yang bertugas memadamkan api saat kebakaran adalah...', emoji: '🧑‍🚒', options: ['Polisi', 'Nelayan', 'Pemadam kebakaran', 'Tukang pos'], correctIndex: 2),
    const Question(question: 'Tempat kita membuang sampah agar lingkungan bersih adalah...', emoji: '🗑️', options: ['Tempat sampah', 'Sungai', 'Jalan raya', 'Selokan'], correctIndex: 0),
    const Question(question: 'Orang yang menangkap ikan di laut disebut...', emoji: '🎣', options: ['Petani', 'Nelayan', 'Peternak', 'Pedagang'], correctIndex: 1),
    const Question(question: 'Lambang negara Indonesia adalah burung...', emoji: '🦅', options: ['Merpati', 'Garuda', 'Elang', 'Cendrawasih'], correctIndex: 1),
    const Question(question: 'Alat transportasi yang terbang di udara adalah...', emoji: '✈️', options: ['Kapal laut', 'Sepeda', 'Pesawat terbang', 'Bus'], correctIndex: 2),
    const Question(question: 'Kepala keluarga di dalam sebuah keluarga biasanya adalah...', emoji: '👨', options: ['Ayah', 'Adik', 'Kakek', 'Paman'], correctIndex: 0),
    const Question(question: 'Orang yang menanam padi dan sayuran di sawah disebut...', emoji: '👨‍🌾', options: ['Dokter', 'Petani', 'Guru', 'Pilot'], correctIndex: 1),
    Question.trueFalse(statement: 'Menjaga kebersihan lingkungan adalah tugas semua orang.', isTrue: true, emoji: '🧹'),
    Question.trueFalse(statement: 'Polisi bertugas mengobati orang yang sakit.', isTrue: false, emoji: '👮'),
    Question.trueFalse(statement: 'Sepeda adalah alat transportasi darat.', isTrue: true, emoji: '🚲'),
    Question.trueFalse(statement: 'Menebang pohon sembarangan baik untuk lingkungan.', isTrue: false, emoji: '🌳'),
    Question.trueFalse(statement: 'Kakak dan adik adalah bagian dari anggota keluarga.', isTrue: true, emoji: '👨‍👩‍👧‍👦'),
    const Question(question: 'Alat transportasi laut yang mengapung dan mengangkut penumpang disebut ...', emoji: '🚢', type: QuestionType.fillBlank, answer: 'kapal'),
    const Question(question: 'Orang yang mengantarkan surat ke rumah-rumah adalah tukang ...', emoji: '📮', type: QuestionType.fillBlank, answer: 'pos'),
